...
import { escapeHtml, isValidName, isValidPflegegrad, isValidPhone } from '@/lib/security'
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!isValidPflegegrad(data.pflegegrad)) {
      return NextResponse.json(
    ...
    const safePflegegrad = data.pflegegrad ? escapeHtml(data.pflegegrad) : ''
