        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 h-20 md:h-28 flex items-center justify-between">
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-[#1F2937] hover:text-[#134E4A] font-medium font-body text-base transition-colors antialiased
                  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2 rounded-md px-1
          ...
          <div className="flex items-center lg:hidden ml-auto gap-x-4">
             <button
              ...
              className="p-2 text-gray-600 hover:text-[#134E4A] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] rounded-lg"
            ...
            <div className="p-6 space-y-4">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block text-xl font-medium text-[#1F2937] hover:text-[#134E4A] py-3 border-b border-gray-50 font-body focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2 rounded-md px-2"
                >
                  {link.label}
                </Link>
              ))}
