            ...
            <aside className="lg:w-80 flex-shrink-0">
              <div className="lg:sticky lg:top-36">
                ...
                <button
                  ...
                  className="lg:hidden w-full flex items-center justify-between p-4 glass rounded-xl mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2"
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    {activeFilters.length > 0 && (
                      <button
                        ...
                        className="ml-auto text-sm text-[#0D6E64] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2 rounded"
                      >
                        Alle löschen
                      </button>
                    )}
                      ...
                      <div className="space-y-2">
                        {['Flexibel', 'Mo-Fr', 'Täglich', '24/7'].map((option) => (
                          <button
                            ...
                            className={`
                              w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2
