    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 md:pt-32 pb-12 md:pb-24 px-4 text-center bg-white">
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#6B7280] max-w-2xl mx-auto leading-relaxed mb-10">
            Gerne beraten wir Sie persönlich und barrierefrei auf Deutsch, Türkisch oder Englisch.
          </p>

          {/* Personalization Info */}
          <div className="flex flex-col items-center gap-4">
            <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-[#144E41]/10 shadow-lg">
              <Image
            ...
            <div className="flex flex-col items-center">
              <span className="text-sm font-bold text-[#144E41] uppercase tracking-widest">Asiye Duman</span>
              <p className="text-gray-500 italic mt-1 font-medium">„Wir begleiten Sie mit Herz und Verstand“</p>
            </div>
          </div>
        </div>
      </section>
