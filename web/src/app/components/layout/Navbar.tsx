            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`font-body text-base transition-colors antialiased
                    ${isActive ? 'text-[#134E4A] font-bold' : 'text-[#1F2937] hover:text-[#134E4A] font-medium'}
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    aria-current={isActive ? 'page' : undefined}
                    className={`block text-xl py-3 border-b border-gray-50 font-body ${
                      isActive ? 'text-[#134E4A] font-bold' : 'text-[#1F2937] hover:text-[#134E4A] font-medium'
                    }`}
                  >
                    {link.label}
