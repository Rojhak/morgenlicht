...
const services = [
  ...
  },
  {
    ...
    ctaLabel: 'Begleitung',
    items: [
      { title: 'Begleitung zum Arzt', desc: 'Sichere Begleitung zu Ihren Terminen beim Arzt, zur Physiotherapie oder zu anderen Behandlungen.', icon: Stethoscope },
      { title: 'Begleitung zu Dienstleistern', desc: 'Gemeinsame Wege zur Bank, zum Friseur, zur Fußpflege oder zu anderen Dienstleistern im Kiez.', icon: Scissors },
      { title: 'Behördengänge', desc: 'Ob Bürgeramt oder Krankenkasse – wir stehen Ihnen bei Terminen zur Seite und helfen direkt vor Ort.', icon: Landmark },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Schriftverkehr', desc: 'Hilfe beim Verfassen einfacher Briefe oder E-Mails sowie beim Führen des Haushaltsbuchs.', icon: ClipboardList },
      { title: 'Antragshilfe', desc: 'Gemeinsames Ausfüllen von Formularen und Anträgen für die Pflegekasse oder Behörden.', icon: FileText },
      ...
      { title: 'Telefon & Organisation', desc: 'Übernahme von wichtigen Telefonaten und Planung von Familienfeiern oder Reisen.', icon: PhoneCall },
