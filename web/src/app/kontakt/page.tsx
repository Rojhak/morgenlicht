            ...
            <form onSubmit={handleSubmit} className="space-y-6 flex-grow">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-lg border focus:ring-1 bg-white transition-all outline-none resize-none ${
                    (formData.message?.length || 0) > 2000
                      ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                      : 'border-gray-200 focus:border-[#144E41] focus:ring-[#144E41]'
                  }`}
                  aria-invalid={(formData.message?.length || 0) > 2000}
                />
                <div
                  className={`text-xs text-right mt-1 font-medium ${
                    (formData.message?.length || 0) > 2000 ? 'text-red-500' : 'text-gray-500'
                  }`}
                  aria-live="polite"
                  aria-atomic="true"
                >
                  {(formData.message?.length || 0)} / 2000 Zeichen
                </div>
              </div>
