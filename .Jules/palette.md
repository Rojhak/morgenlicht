...
## 2026-05-14 - Custom Checkbox/Radio Filter Buttons
**Learning:** Custom interactive elements (like filter <button> elements simulating checkboxes) must have explicit aria-pressed attributes so screen readers announce their state.
**Action:** Always bind aria-pressed to the component's state variable and ensure custom elements have a focus-visible:ring for keyboard users.
