...
export function CareFinder() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full scroll-mt-32 outline-none"
      tabIndex={-1}
    >
      {/* Progress Indicator */}
      ...
      {step === 'result' && hours > 0 && (
        <div className="space-y-8">
          ...
          >
            <summary className="flex items-center justify-between w-full p-4 cursor-pointer hover:bg-gray-100 rounded-xl transition-colors select-none">
