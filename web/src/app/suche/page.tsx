                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    {activeFilters.length > 0 && (
                      <button
                        ...
                        className="ml-auto text-sm text-[#0D6E64] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#134E4A] focus-visible:ring-offset-2 rounded-lg"
                      >
                        Alle löschen
                      </button>
                    )}
