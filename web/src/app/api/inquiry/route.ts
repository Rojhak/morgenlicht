...
import { escapeHtml, validateInquiryInput } from '@/lib/security'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validation = validateInquiryInput(rawData)
    ...
    const safePflegegrad = pflegegrad ? escapeHtml(pflegegrad) : undefined
