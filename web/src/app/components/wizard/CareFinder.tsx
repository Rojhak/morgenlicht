      ...
      <div className="max-w-3xl mx-auto">
        ...
        <GlassCard className="p-8 md:p-10 shadow-xl border-0">
          ...
          <div
            ref={contentRef}
            tabIndex={-1}
            className="focus:outline-none scroll-mt-20"
          >
            ...
            {step === 'result' && hours > 0 && (
              <div className="space-y-8">
                ...
                {/* Details Toggle */}
                <details className="bg-white/50 rounded-2xl group">
                  <summary
                    className="flex items-center justify-between w-full p-5 cursor-pointer hover:bg-white/70 rounded-2xl transition-colors select-none list-none [&::-webkit-details-marker]:hidden"
                  >
                    <span className="font-semibold text-[#37474F] text-lg">Details anzeigen</span>
                    <span className="text-[#546E7A] transition-transform duration-300 group-open:rotate-180">▼</span>
                  </summary>
