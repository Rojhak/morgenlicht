      ...
      <div className="max-w-3xl mx-auto px-6 pb-24">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
          ...
          <div className="flex flex-col gap-12 max-w-md mx-auto">
            ...
            <div className="flex gap-5 items-start focus-within:ring-2 focus-within:ring-[#144E41]/20 rounded-xl p-1 -m-1 transition-all">
              <a href="tel:015156057365" className="w-12 h-12 bg-[#F0FDF4] rounded-xl flex items-center justify-center shrink-0 hover:bg-[#DCFCE7] transition-colors" aria-label="WhatsApp oder Mobil anrufen">
