                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    {activeFilters.length > 0 && (
                      <button
                        ...
                        className="ml-auto text-sm text-[#0D6E64] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0D6E64] focus-visible:ring-offset-2 rounded-sm"
                      >
                        Alle löschen
                      </button>
                    )}
                      ...
                      <div className="space-y-2">
                        {['Berlin-Kreuzberg', 'Berlin-Neukölln', 'Berlin-Friedrichshain', 'Prenzlauer Berg', 'Charlottenburg'].map((option) => (
                          <button
                            ...
                            className={`
                              w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all
                              focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B8472A] focus-visible:ring-offset-2
