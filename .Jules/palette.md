...
## 2026-06-05 - Screen reader state for custom toggle buttons
**Learning:** When using `<button>` elements to represent custom toggleable filters or checkboxes, screen readers do not announce their active state unless explicitly told.
